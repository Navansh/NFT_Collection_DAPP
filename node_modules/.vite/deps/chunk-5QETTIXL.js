...
var init_base = __esm({
  "node_modules/multiformats/esm/src/bases/base.js"() {
    ...
    from = ({ name: name3, prefix, encode: encode6, decode: decode7 }) => new Codec(name3, prefix, encode6, decode7);
    baseX = ({ prefix, name: name3, alphabet: alphabet2 }) => {
    ...
    decode4 = (string2, alphabet2, bitsPerChar, name3) => {
      const codes = {};
    ...
    rfc4648 = ({ name: name3, prefix, bitsPerChar, alphabet: alphabet2 }) => {
      return from({
        prefix,
        name: name3,
        encode(input) {
      ...
      static create(version2, code3, digest2) {
        ...
        switch (version2) {
          ...
          case 1: {
            ...
            return new CID(version2, code3, digest2, bytes);
          }
          default: {
...
var init_hasher = __esm({
  "node_modules/multiformats/esm/src/hashes/hasher.js"() {
    init_digest();
    from2 = ({ name: name3, code: code3, encode: encode6 }) => new Hasher(name3, code3, encode6);
    Hasher = class {
...
var code2, name2, encode5, digest, identity2;
var init_identity2 = __esm({
  "node_modules/multiformats/esm/src/hashes/identity.js"() {
    ...
    name2 = "identity";
    encode5 = coerce;
    digest = (input) => create(code2, encode5(input));
    identity2 = {
      code: code2,
      name: name2,
      encode: encode5,
...
//# sourceMappingURL=chunk-5QETTIXL.js.map
