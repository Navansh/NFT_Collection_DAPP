...
var require_base64 = __commonJS({
  "node_modules/@protobufjs/base64/index.js"(exports2) {
    ...
    var i;
    base64.encode = function encode7(buffer2, start, end) {
    ...
    base64.decode = function decode7(string, buffer2, offset) {
      var start = offset;
      var j = 0, t;
...
var require_writer = __commonJS({
  "node_modules/protobufjs/src/writer.js"(exports2, module2) {
    ...
    Writer.prototype.bytes = function write_bytes(value) {
      ...
      if (util.isString(value)) {
        var buf2 = Writer.alloc(len = base64.length(value));
...
var require_BufferList = __commonJS({
  "node_modules/bl/BufferList.js"(exports2, module2) {
    ...
    BufferList3.prototype.toString = function toString2(encoding, start, end) {
  ...
  "node_modules/@assemblyscript/loader/index.js"(exports2) {
    ...
    function postInstantiate(baseModule, instance) {
      ...
      function __allocString(str) {
        ...
        const ptr = alloc2(length << 1, STRING_ID);
      ...
      function __allocArray(id, values) {
        ...
        const buf2 = alloc2(length << align, ARRAYBUFFER_ID);
      ...
      function __getArrayView(arr) {
        ...
        const length = info & ARRAY ? U32[arr + ARRAY_LENGTH_OFFSET >>> 2] : U32[buf2 + SIZE_OFFSET >>> 2] >>> align;
        return getView(align, info & VAL_SIGNED, info & VAL_FLOAT).subarray(buf2 >>>= align, buf2 + length);
      }
...
var decode3 = (data) => decode2(data, decodeOptions);
...
async function readVarint(reader) {
  ...
  reader.seek(import_varint.default.decode.bytes);
  return i;
}
...
async function readMultihash(reader) {
  ...
  const codeLength = import_varint.default.decode.bytes;
  const length = import_varint.default.decode(bytes.subarray(import_varint.default.decode.bytes));
  const lengthLength = import_varint.default.decode.bytes;
...
async function readCid(reader) {
  ...
  if (first[0] === CIDV0_BYTES.SHA2_256 && first[1] === CIDV0_BYTES.LENGTH) {
    ...
    reader.seek(34);
    const multihash2 = decode(bytes2);
...
function createEncoder(writer) {
  return {
    ...
    async writeBlock(block) {
      ...
      await writer.write(new Uint8Array(import_varint2.default.encode(cid.bytes.length + bytes.length)));
...
var name = "dag-cbor";
var code2 = 113;
var encode4 = (node) => encode(node, encodeOptions2);
var decode4 = (data) => decode2(data, decodeOptions2);
...
function createLink(name3, size, cid) {
  return asLink({
    Hash: cid,
    Name: name3,
    Tsize: size
...
var Data = $root.Data = (() => {
  ...
  Data2.decode = function decode7(r, l) {
...
var UnixTime = $root.UnixTime = (() => {
  ...
  UnixTime2.decode = function decode7(r, l) {
    if (!(r instanceof $Reader))
      r = $Reader.create(r);
...
var Metadata = $root.Metadata = (() => {
  ...
  Metadata2.decode = function decode7(r, l) {
    if (!(r instanceof $Reader))
      r = $Reader.create(r);
...
var Token2 = class {
  ...
  static async encode(input) {
    ...
    for (const [dotPath, blob] of blobs.entries()) {
      const name3 = blob.name || "blob";
      const content = blob.stream();
      const { root: cid } = await pack({
        input: [{ path: name3, content }],
        blockstore,
        wrapWithDirectory: true
      });
      const href = new URL(`ipfs://${cid}/${name3}`);
...
var decode6 = ({ ipnft, url, data }, paths) => new Token2(ipnft, url, mapWith(data, isEncodedURL, decodeURL, paths));
...
var NFTStorage = class {
   ...
   * @returns {Promise<CIDString>}
   */
  static async storeCar({ endpoint, rateLimiter = globalRateLimiter, ...token }, car, { onStoredChunk, maxRetries, decoders, signal } = {}) {
...
var validateERC1155 = ({ name: name3, description, image, decimals }) => {
